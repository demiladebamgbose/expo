...
export function storeUrl(): string | null {
  ...
  console.warn(
    "Expo.StoreReview.requestReview(): Couldn't link to store, please make sure the `android.playStoreUrl` & `ios.appStoreUrl` fields are filled out in your `app.config.js`"
  );
  return null;
}
