...
export function storeUrl() {
    const { android, ios } = require('../../../app.config.js');
    // eslint-disable-next-line no-undef
    if (Platform.OS === 'ios' && ios) {
        return ios.appStoreUrl;
        // eslint-disable-next-line no-undef
    }
    else if (Platform.OS === 'android' && android) {
        return android.playStoreUrl;
    }
    console.warn("Expo.StoreReview.requestReview(): Couldn't link to store, please make sure the `android.playStoreUrl` & `ios.appStoreUrl` fields are filled out in your `app.config.js`");
    return null;
}
/**
